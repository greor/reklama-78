...
abstract class Kohana_Image {
	 ...
	 * @uses    Image::_do_crop
	 */
	public function truncate($color, $distance, $top = NULL, $right = NULL, $bottom = NULL, $left = NULL)
	{
		$this->_do_truncate($color, $distance, $top, $right, $bottom, $left);
	 ...
	 *
	 * @param   integer  $color1	Color index 1
	 * @param   integer  $color2	Color index 2
	 * @return  distance
	 */
	public static function colordist($color1, $color2){
	 ...
	 * @return  void
	 */
	abstract protected function _do_truncate($color, $distance, $top, $right, $bottom, $left);
